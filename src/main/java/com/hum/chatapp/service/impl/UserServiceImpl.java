...
//        }
    ...
    public ResponseEntity<ApiResponse> getListConversationResponse(String userId){
        List<ConversationResponse> listConversation = conversationRepository.findConversationsByUserId(userId);
        return new ResponseEntity<>(
                ApiResponse.builder()
                        .statusCode(200)
                        .status("Success")
